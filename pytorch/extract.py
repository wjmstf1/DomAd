...
pthfile = r'./snapshot/log/rwTpr/known_best_model.pth'
net = torch.load(pthfile).cpu()
pthfile1 = r'./snapshot/log/rwTpr/unknown_onemore_best_model.pth'
net1 = torch.load(pthfile1).cpu()
net3 = net1[0]
net2 = net1[1]
#for name in net3.state_dict():
#    print(name)
...
dsets = {}
dset_loaders = {}
dsets["source"] = ImageList(open('../data/office-home/rw_tsne_8.txt').readlines(), \
...
sio.savemat('rw_rwTpr_8.mat', {'fea':features_source_total.data.numpy()})
sio.savemat('rw_rwTpr_label_8.mat', {'lab':label_source_total.data.numpy()})
...
sio.savemat('pr_rwTpr_9.mat', {'fea':features_target_total.data.numpy()})
sio.savemat('pr_rwTpr_label_9.mat', {'lab':label_target_total.data.numpy()})
